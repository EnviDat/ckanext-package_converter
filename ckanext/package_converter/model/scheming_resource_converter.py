...
from ckanext.package_converter.model.scheming_converter import Datacite31SchemingConverter, Datacite42SchemingConverter
...
class Datacite42SchemingResourceConverter(Datacite42SchemingConverter):

    def __init__(self):
        Datacite42SchemingConverter.__init__(self)
        ckan_resource_base_format = MetadataFormats().get_metadata_formats('ckan_resource')[0]
        self.input_format = ckan_resource_base_format
